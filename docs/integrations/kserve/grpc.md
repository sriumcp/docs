...
??? note "About this experiment"
    This experiment consists of three tasks, namely, [ready](../../user-guide/tasks/ready.md), [grpc](../../user-guide/tasks/grpc.md), and [assess](../../user-guide/tasks/assess.md). 
    
    The [ready](../../user-guide/tasks/ready.md) task checks if the `sklearn-irisv2` InferenceService exists and is `Ready`. 

    The [grpc](../../user-guide/tasks/grpc.md) task sends call requests to the `inference.GRPCInferenceService.ModelInfer` method of the cluster-local gRPC service with host address `${GRPC_HOST}:${GRPC_PORT}`, and collects performance metrics.
...
You can view experiment report as described in [your first experiment](../../getting-started/your-first-experiment.md).
