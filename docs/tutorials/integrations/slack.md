...
??? note "Some variations and extensions of the `slack` task"
    The default `slack` task [payload](https://raw.githubusercontent.com/iter8-tools/hub/iter8-0.14.0/templates/notify/_payload-slack.tpl) sends the entirety of the experiment report.
