...
??? note "About this experiment"
    This experiment consists of three tasks, namely, [ready](../../user-guide/tasks/ready.md), [http](../../user-guide/tasks/http.md), and [assess](../../user-guide/tasks/assess.md). 
    
    The [ready](../../user-guide/tasks/ready.md) task checks if the `sklearn-irisv2` InferenceService exists and is `Ready`. 

    The [http](../../user-guide/tasks/http.md) task sends requests to the cluster-local HTTP service whose URL exposed by the InferenceService, `http://sklearn-irisv2.default.svc.cluster.local/v2/models/sklearn-irisv2/infer`, and collects [performance metrics](../../user-guide/tasks/http.md#metrics). 
    ...
    This is a single-loop experiment where all the previously mentioned tasks will run once and the experiment will finish (indicated by the `runner=job` setting).

***

You can view an experiment report as described in [your first experiment](../../getting-started/your-first-experiment.md).
